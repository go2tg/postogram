...
Из-за игры слов русское название выглядит несколько неоднозначно. Поэтому принято решение немного его изменить так, чтобы лучше отражало цель проекта. Но внутри команды неофициально мы по прежнему используем неизмененное название. Просто так веселей. :) 
